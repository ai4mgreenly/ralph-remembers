...
ifdef FILE
	...
	@find tests/unit -type d 2>/dev/null | sed 's|^tests/|reports/check/|' | xargs mkdir -p 2>/dev/null || true
	@for bin in $$(find $(SANITIZE_BUILDDIR)/tests/unit \
	...
	@tmpdir=$$(mktemp -d); \
	find $(SANITIZE_BUILDDIR)/tests/unit \
